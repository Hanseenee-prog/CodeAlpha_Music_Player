...
import PlaylistDropdownMenu from './ModalsOrPopovers/PlaylistDropdownMenu.jsx';
...
const PlayList = () => {
    ...
    // Handler for when the user clicks "Save" in the new modal
    const handleAddSongsConfirm = (selectedSongs) => {
        // context function to update DB/State
        addToPlaylist(playlist.playlistId, selectedSongs);
